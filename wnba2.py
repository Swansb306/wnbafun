...
df2 = df2.merge(df[['prob1','elo1_pre','elo2_pre']], 
              ...
              how='left')
"""
#this is for making our Dependent variables
...
"some quick descriptive stats for df2"
...
###prep for modeling with test and train split
"start modeling"
train = df.copy()
test = df.copy()
...
#this gives you a summary because sklearn doesn't have an easy summary option. 
...
##### 2024 data
df2024 = pd.read_csv("wnba2024dvoa2.csv")
...
df2025 = pd.read_csv("wnba2025withoffense_june11.csv")
...
###### at this point we are trying to use the model to predict for with new data
#####When I was first working on it this was during week11 of the season. 

"week 11"
df2025week11 = pd.read_csv("weekofjune11.csv")
...
########more data exploration using seaborn for df2
_ = sns.scatterplot(
    x="elo1_pre",
    y="team1_offense_metric",
    data=df2[:n_samples_to_plot],
...
####exploring decision trees and other alternative methods/models
...
#This previous one is not very informative.
sns.scatterplot(
...
sns.scatterplot(
    x=data_train['team1_offense_metric'], y=data_train['point_diff'], color="black", alpha=1
)
'Positive correlation here but it is noisy'
...
print(bagged_trees_predictions)

######end of regular season evaluation.... how did we do? 